...
class DeepLearningModel(BaseModel):
    def _train(self, train_features: torch.Tensor, train_labels: torch.Tensor, val_features: torch.Tensor, val_labels: torch.Tensor, *args, verbose=True, weights=None, delay_val=True):
        epochs = 100
